...
func newV2TestRouter(controller *Controller) *mux.Router {
	...
	encodedPathRouter.HandleFunc("/api/v2/users/{user}/kick", httppkg.MakeHTTPHandlerFuncV2(controller.APIV2UserKick)).Methods(http.MethodPost)
	encodedPathRouter.HandleFunc("/api/v2/clients/{key}/kick", httppkg.MakeHTTPHandlerFuncV2(controller.APIV2ClientKick)).Methods(http.MethodPost)
